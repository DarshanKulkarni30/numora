...
export const HOW_TO_READ_ENHANCED = assertSafeList(
  [
    ...
    "This page is one story: how Birth, Destiny, Name, and Soul work together, plus this year’s Personal Year and Name Cycle. Name numbers use Chaldean letters. Open Detailed for every method — including Pythagorean Essence transits — or Comprehensive for the four-node Chaldean story.",
...
export const HOW_TO_READ_DETAILED = assertSafeList(
  [
    ...
    "This page is the full catalog. Open Personal Blueprint for one story, or Comprehensive for a Chaldean-first story.",
  ],
  "howto.detailed",
);
