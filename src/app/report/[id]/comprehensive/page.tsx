...
import { ComprehensiveReportView } from "@/components/comprehensive/ComprehensiveReportView";
import {
  reportCopyUnlocked,
  resolveEntitlements,
  type EntitlementRow,
...
export default async function ComprehensiveReportPage({ params }: Props) {
