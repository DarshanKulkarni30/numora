      ...
      <main className="mx-auto max-w-6xl px-5 pb-20 pt-6">
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-ink-soft">
            People who share your numerology tones — a match gallery and birth-date
            strip, plus countries and cities. Reflective fun only—not destiny,
            endorsement, or relocation advice.
          </p>
        </div>
        <div className="mt-10">
