...
| Pattern / year table / stars | Collapsed table cells read as “Moderate Expression”; year table was only a theme; three star rows had no key | Flow visual + pair headlines. Year journey practise line, not only Build × Start. Transition = leave / this week / next year in plain titles. Star key: core stays still; year = method; Name Cycle = showing-up. Vedic cards stack under the grid, full width. |
